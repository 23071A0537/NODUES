...
async function runMigration010() {
  try {
    console.log('========================================');
    console.log('Running Migration 010: Alumni Dues Table');
    console.log('========================================\n');

    const migrationPath = path.join(__dirname, 'migrations', '010_add_alumni_dues_table.sql');
    ...
    console.error('\n✗ Migration 010 failed:', err.message);
    process.exit(1);
  }
}
