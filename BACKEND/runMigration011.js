...
async function runMigration011() {
  try {
    console.log('========================================');
    console.log('Running Migration 011: Alumni Form Submission Columns');
    console.log('========================================\n');

    const migrationPath = path.join(__dirname, 'migrations', '011_add_alumni_form_submission_columns.sql');
